...
#### Week 17 has no impact on the championship as it is played in weeks 15 & 16
...
### The total prize money for the `r current_season` season will be $`r sum(payouts$payout_total)` and will be distributed as follows
